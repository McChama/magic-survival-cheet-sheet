...
export const RESEARCH: ResearchDefinition[] = [
  { id: "intelligence", name: "Intelligence", image: researchImage("intelligence.png"), maxLevel: 6, valuesByLevel: [0, 5, 10, 15, 20, 25, 30], statKey: "atk", descriptionTemplate: "Increase ATK by □%", descriptionColor: "#E1FFAF" }, // source id 261
  {
    ...
    name: "Vitality", image: researchImage("vitality.png"), maxLevel: 6, valuesByLevel: [0, 10, 20, 30, 40, 50, 60], statKey: "hp",
    ...
    secondaryValuesByLevel: [0, 5, 10, 15, 20, 25, 30],
  },
  { id: "manarefining", name: "Mana Refining", image: researchImage("manarefining.png"), maxLevel: 6, valuesByLevel: [0, 3, 6, 9, 12, 15, 18], statKey: "manaAcquisition", descriptionTemplate: "Increase Mana Acquisition by □%", descriptionColor: "#E1FFAF" }, // source id 263
  ...
  { id: "explorer", name: "Explorer", image: researchImage("explorer.png"), maxLevel: 4, valuesByLevel: [0, 10, 20, 30, 40], statKey: "itemPickupRange", descriptionTemplate: "Increase Item Pickup Range by □%", descriptionColor: "#E1FFAF" }, // source id 270
  ...
  { id: "recycle", name: "Recycle", image: researchImage("recycle.png"), maxLevel: 4, valuesByLevel: [0, 5, 10, 15, 20], statKey: null, descriptionTemplate: "Retrieve 〈□%〉 more Mana when retrieving Mana.", descriptionColor: "#E1FFAF" }, // source id 273
  ...
  { id: "growth", name: "Growth", image: researchImage("growth.png"), maxLevel: 4, valuesByLevel: [0, 1, 2, 3, 4], statKey: null, descriptionTemplate: "Every [20] levels increase [ATK] and [Max HP] by 〈□%〉.", descriptionColor: "#EBEBEB" }, // source id 277
  ...
  { id: "luck", name: "Luck", image: researchImage("luck.png"), maxLevel: 5, valuesByLevel: [0, 5, 10, 15, 20, 25], statKey: null, descriptionTemplate: "Field items are created 〈□%〉 more often.", descriptionColor: "#EBEBEB" }, // source id 279
  { id: "loot", name: "Loot", image: researchImage("loot.png"), maxLevel: 6, valuesByLevel: [0, 3, 6, 9, 12, 15, 18], statKey: null, descriptionTemplate: "[Treasure Chests] are created 〈□%〉 more frequently.", descriptionColor: "#EBEBEB" }, // source id 280
